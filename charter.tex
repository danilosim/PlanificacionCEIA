...
3      & Se completa hasta el punto 12 inclusive                & 26 de mayo de 2025 \\ \hline
...
\begin{itemize}
  \item \textbf{Épica 1: planificación y organización del proyecto}
    \begin{itemize}
      ...
      \newline \textbf{Dificultad: 5} — \textbf{Complejidad: 3} — \textbf{Incertidumbre: 5} — \textbf{Story Points: 13}

      \item \textbf{HU2:} como estudiante, quiero actualizar y ajustar el \textit{backlog} y el plan de trabajo según avances reales y obstáculos encontrados.  
      \newline \textbf{Dificultad: 3} — \textbf{Complejidad: 2} — \textbf{Incertidumbre: 3} — \textbf{Story Points: 8}
    \end{itemize}
  ...
  \item \textbf{Épica 2: relevamiento y análisis de datos históricos}
    \begin{itemize}
      ...
      \newline \textbf{Dificultad: 5} — \textbf{Complejidad: 5} — \textbf{Incertidumbre: 5} — \textbf{Story Points: 21}
      ...
      \newline \textbf{Dificultad: 4} — \textbf{Complejidad: 5} — \textbf{Incertidumbre: 5} — \textbf{Story Points: 21}
    \end{itemize}
  ...
  \item \textbf{Épica 3: preprocesamiento y preparación de datos}
    \begin{itemize}
      ...
      \newline \textbf{Dificultad: 3} — \textbf{Complejidad: 3} — \textbf{Incertidumbre: 3} — \textbf{Story Points: 13}
      ...
      \newline \textbf{Dificultad: 4} — \textbf{Complejidad: 3} — \textbf{Incertidumbre: 4} — \textbf{Story Points: 13}
    \end{itemize}
  ...
  \item \textbf{Épica 4: entrenamiento y validación de modelos}
    \begin{itemize}
      ...
      \newline \textbf{Dificultad: 5} — \textbf{Complejidad: 4} — \textbf{Incertidumbre: 5} — \textbf{Story Points: 21}
  ...
  \item \textbf{Épica 5: interpretación, documentación y validación}
    \begin{itemize}
      ...
      \newline \textbf{Dificultad: 4} — \textbf{Complejidad: 3} — \textbf{Incertidumbre: 3} — \textbf{Story Points: 13}
    \end{itemize}
...
Sprint 1 & HU1 & Analizar el alcance del proyecto y elaborar cronograma general & 6 h & Alumno & 100\% \\ \hline
Sprint 1 & HU1 & Dividir el proyecto en fases e identificar dependencias & 4 h & Alumno & 100\% \\ \hline
...
Sprint 1 & HU2 & Establecer rutina de seguimiento semanal & 2 h & Alumno & 50\% \\ \hline
...
\begin{itemize}
    ...
    \item \textbf{CCPA} (\textit{California Consumer Privacy Act}): aplica si hay usuarios residentes en California y otorga derechos sobre el uso de sus datos.
