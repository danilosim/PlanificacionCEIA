  ...
  \item \textbf{Épica 6: sistematización y documentación técnica}
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item La replicabilidad fue validada ejecutando el pipeline en una sesión independiente.
      \end{itemize}
    \end{itemize}
...
HU3 & Detectar y tratar outliers utilizando técnicas estadísticas (IQR, Z-score) & 6 h & Alta \\ \hline
...
HU6 & Implementar un pipeline reproducible de preprocesamiento (usando `Pipeline` de scikit-learn) & 6 h & Alta \\ \hline
...
HU9 (Opcional) & Generar dashboard interactivo de interpretabilidad usando SHAP o Plotly Dash & 6 h & Baja \\ \hline
...
HU13 & Describir la metodología, incluyendo el enfoque CRISP-DM y diseño experimental & 4 h & Alta \\ \hline
